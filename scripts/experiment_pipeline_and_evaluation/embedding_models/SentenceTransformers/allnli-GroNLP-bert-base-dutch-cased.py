...
def retrieve_docs_for_questions_allnli_GroNLP(qa_df, k):
    # Load the CSV file
    ...
    embeddings_file = 'allnli_GroNLP-no_metadata_largecorpus.npy'
...
def retrieve_relevant_docs(k, QA):
    relevant_docs = retrieve_docs_for_questions_allnli_GroNLP(QA, k)
    print(relevant_docs)
...
def main():
    ...
    for config in configurations:
        ...
        evaluate_and_write_results(relevant_docs, QA_loaded, recall_metric=config['recall_metric'], k=config['k'], modelname="allnli_GroNLP")
